...
def create_and_serialize_medication_mapping_dict(args: Namespace, only_cedars: set, all_ucla: set) -> None:

    exceptions = {'ANTIDEPRESSANT - SEROTONIN-2 ANTAGONIST-REUPTAKE INHIBITORS (SARIS)',
    ...
    manual_mapping = { "CALCIUM CHANNEL BLOCKERS - DIHYDROPYRIDINES - CEREBROVASCULAR SPECIFIC": "CALCIUM CHANNEL BLOCKERS",
    ...
    mapping = {'CALCIUM CHANNEL BLOCKERS - DIHYDROPYRIDINES': 'CALCIUM CHANNEL BLOCKERS', 'BETA BLOCKERS CARDIAC SELECTIVE': 'BETA BLOCKERS CARDIO-SELECTIVE', 'INFLAMMATORY BOWEL AGENT - AMINOSALICYLATES AND RELATED AGENTS': 'SALICYLATES', 'DERMATOLOGICAL - TOPICAL LOCAL ANESTHETIC AMIDES': 'LOCAL ANESTHETICS - AMIDES', 'DEXTROSE AND SODIUM CHLORIDE SOLUTIONS': 'SODIUM', 'MINERALS AND ELECTROLYTES - POTASSIUM FOR INJECTION': 'POTASSIUM', 'ANTIFUNGAL - FLUORINATED PYRIMIDINE-TYPE AGENTS': 'ANTIFUNGALS', 'DERMATOLOGICAL - LOCAL ANESTHETIC COMBINATIONS': 'LOCAL ANESTHETIC COMBINATIONS', 'ANTIFUNGAL - GLUCAN SYNTHESIS INHIBITOR, ECHINOCANDINS': 'ANTIFUNGAL - GLUCAN SYNTHESIS INHIBITORS', 'ANALGESIC OPIOID AGONISTS': 'OPIOID AGONISTS', 'PHOSPHATE BINDERS': 'PHOSPHATE', 'ANTIANGINAL - CORONARY VASODILATORS (NITRATES)': 'NITRATES', 'ARTIFICIAL TEARS AND LUBRICANT SINGLE AGENTS': 'ARTIFICIAL TEARS AND LUBRICANTS', 'ANTIANXIETY AGENT - BENZODIAZEPINES': 'BENZODIAZEPINES', 'DERMATOLOGICAL - BURN PRODUCTS ANTI-INFECTIVE': 'BURN PRODUCTS', 'CARDIOVASCULAR SYMPATHOMIMETICS': 'SYMPATHOMIMETICS', 'DIURETIC - LOOP': 'LOOP DIURETICS', 'MINERALS AND ELECTROLYTES - POTASSIUM, ORAL': 'POTASSIUM', 'ANTACID - CALCIUM': 'CALCIUM', 'DIURETIC - CARBONIC ANHYDRASE INHIBITORS': 'CARBONIC ANHYDRASE INHIBITORS', 'METABOLIC MODIFIER - CARNITINE REPLENISHER AGENTS': 'METABOLIC MODIFIERS', 'DIURETIC - SELECTIVE ARGININE VASOPRESSIN V2 RECEPTOR ANTAGONISTS': 'VASOPRESSIN RECEPTOR ANTAGONISTS', 'OPHTHALMIC-INTRAOCULAR PRESSURE REDUCING AGENTS, PROSTAGLANDIN ANALOGS': 'PROSTAGLANDINS', 'OPHTHALMIC ANTIBIOTIC - FLUOROQUINOLONES': 'FLUOROQUINOLONES', 'INSULIN ANALOGS - RAPID ACTING': 'INSULIN', 'MOUTH AND THROAT - ANTISEPTICS': 'ANTISEPTICS - MOUTH/THROAT', 'MINERALS AND ELECTROLYTES - CALCIUM REPLACEMENT': 'CALCIUM', 'DERMATOLOGICAL - TOPICAL LOCAL ANESTHETIC ESTERS': 'LOCAL ANESTHETICS - ESTERS', 'SMOKING DETERRENTS - NICOTINE-TYPE': 'SMOKING DETERRENTS', 'HEPARINS': 'HEPARINS AND HEPARINOID-LIKE AGENTS', 'ABORTIFACIENTS OR CERVICAL RIPENING AGENTS - PROSTAGLANDIN ANALOGS': 'PROSTAGLANDINS', 'URINARY ANTISPASMODIC - SMOOTH MUSCLE RELAXANTS': 'ANTISPASMODICS', 'ANTICOAGULANTS - COUMARIN': 'COUMARIN ANTICOAGULANTS', 'INDIRECT FACTOR XA INHIBITORS': 'DIRECT FACTOR XA INHIBITORS', 'ANTIHISTAMINE - 1ST GENERATION - PHENOTHIAZINES': 'PHENOTHIAZINES', 'ANTIPSYCHOTIC - BUTYROPHENONE DERIVATIVES': 'BUTYROPHENONES', 'INSULINS': 'INSULIN', 'ANTITUBERCULAR - ISONICOTINIC ACID DERIVATIVES': 'NICOTINIC ACID DERIVATIVES', 'ARTIFICIAL TEARS AND LUBRICANT COMBINATIONS': 'ARTIFICIAL TEARS AND LUBRICANTS', 'SYSTEMIC SYMPATHOMIMETIC DECONGESTANTS': 'SYMPATHOMIMETIC DECONGESTANTS', 'MINERALS AND ELECTROLYTES - IRON': 'IRON', 'AMINOGLYCOSIDE ANTIBIOTIC': 'AMINOGLYCOSIDES', 'DMARD - PYRIMIDINE SYNTHESIS INHIBITORS': 'PYRIMIDINE SYNTHESIS INHIBITORS', 'PLATELET AGGREGATION INHIBITORS - PHOSPHODIESTERASE III INHIBITORS': 'PLATELET AGGREGATION INHIBITORS', 'DIAGNOSTIC RADIOPHARMACEUTICALS - RENAL IMAGING': 'DIAGNOSTIC RADIOPHARMACEUTICALS', 'DIAGNOSTIC DRUGS - IN VIVO OTHER': 'DIAGNOSTIC DRUGS', 'ANTIHYPERGLYCEMIC - SULFONYLUREA DERIVATIVES': 'SULFONYLUREAS', 'ANTINEOPLASTIC - ANTIMETABOLITE - FOLIC ACID ANALOGS': 'ANTIMETABOLITES', 'AMINOPENICILLIN ANTIBIOTIC': 'AMINOPENICILLINS', 'OPHTHALMIC - BETA BLOCKERS-CARBONIC ANHYDRASE INHIBITOR COMBINATIONS': 'CARBONIC ANHYDRASE INHIBITORS', 'CARBAPENEM ANTIBIOTICS (THIENAMYCINS)': 'CARBAPENEMS', 'ANTACID - BICARBONATE': 'ANTACIDS - BICARBONATE', 'DERMATOLOGICAL - EMOLLIENT MIXTURES': 'EMOLLIENTS', 'ANTINEOPLASTIC ANTIBIOTIC - ANTHRACYCLINES': 'ANTINEOPLASTIC ANTIBIOTICS', 'PROSTATIC HYPERTROPHY AGENT - ALPHA-1-ADRENOCEPTOR ANTAGONISTS': 'PROSTATIC HYPERTROPHY AGENTS', 'ANTIDIURETIC AND VASOPRESSOR HORMONES': 'VASOPRESSORS', 'LAXATIVE - LUBRICANT': 'LUBRICANT LAXATIVES', 'SODIUM CHLORIDE, PARENTERAL': 'SODIUM', 'THYROID HORMONES - SYNTHETIC T4 (THYROXINE)': 'THYROID HORMONES', 'THYROID HORMONES - SYNTHETIC T3 (TRIIODOTHYRONINE)': 'THYROID HORMONES', 'ANTIPSYCHOTIC - PHENOTHIAZINES, PIPERAZINE': 'PHENOTHIAZINES', 'MINERALS AND ELECTROLYTES - MAGNESIUM': 'MAGNESIUM', 'MUSCULOSKELETAL THERAPY AGENT - VISCOSUPPLEMENTS': 'VISCOSUPPLEMENTS', 'ANTINEOPLASTIC - ANTIMETABOLITE - UREA DERIVATIVES': 'ANTIMETABOLITES', 'TETRACYCLINE ANTIBIOTICS': 'TETRACYCLINES', 'GI ANTISPASMODIC - BELLADONNA ALKALOIDS': 'ANTISPASMODICS', 'ANTIPSYCHOTIC - ATYPICAL DOPAMINE-SEROTONIN ANTAG- BENZISOXAZOLE DERIV': 'BENZISOXAZOLES', 'LINCOSAMIDE ANTIBIOTICS': 'LINCOSAMIDES', 'ASTHMA/COPD -  PHOSPHODIESTERASE-4 (PDE4) INHIBITORS': 'PHOSPHODIESTERASE 4 (PDE4) INHIBITORS', 'GASTRIC ACID SECRETION REDUCING AGENTS - PROTON PUMP INHIBITORS (PPIS)': 'PROTON PUMP INHIBITORS', 'ANTIDIARRHEAL - ANTIPERISTALTIC AGENTS': 'ANTIPERISTALTIC AGENTS', 'B-COMPLEX VITAMIN COMBINATIONS': 'B-COMPLEX VITAMINS', 'ANTIRETROVIRAL-NUCLEOSIDE ANALOGS AND INTEGRASE INHIBITOR COMBINATIONS': 'ANTIRETROVIRALS', 'ANTIEMETIC - PHENOTHIAZINES': 'PHENOTHIAZINES', 'OPIOID ANTITUSSIVE-EXPECTORANT COMBINATIONS': 'ANTITUSSIVES', 'ANTIHYPERLIPIDEMIC - HMG COA REDUCTASE INHIBITORS (STATINS)': 'HMG COA REDUCTASE INHIBITORS', 'ANTIDEPRESSANT - SELECTIVE SEROTONIN REUPTAKE INHIBITORS (SSRIS)': 'SELECTIVE SEROTONIN REUPTAKE INHIBITORS (SSRIS)', 'ANTIHYPERLIPIDEMIC - BILE ACID SEQUESTRANTS': 'BILE ACID SEQUESTRANTS', 'SKELETAL MUSCLE RELAXANT - CENTRAL MUSCLE RELAXANTS': 'CENTRAL MUSCLE RELAXANTS', 'SEDATIVE-HYPNOTIC - BENZODIAZEPINES': 'BENZODIAZEPINES', 'ANTIRETROVIRAL - NON-NUCLEOSIDE REVERSE TRANSCRIPTASE INHIB (NNRTI)': 'ANTIRETROVIRALS', 'MULTIVITAMIN AND MINERAL COMBINATIONS': 'MINERAL COMBINATIONS', 'GLYCOPEPTIDE ANTIBIOTICS': 'GLYCOPEPTIDES', 'DERMATOLOGICAL - EMOLLIENTS': 'EMOLLIENTS', 'MIGRAINE THERAPY - SELECTIVE SEROTONIN AGONISTS 5-HT(1)': 'SEROTONIN AGONISTS', 'MINERALS AND ELECTROLYTES - BICARBONATE PRODUCING OR CONTAINING AGENTS': 'BICARBONATES', 'LOCAL ANESTHETIC - AMIDES': 'LOCAL ANESTHETICS - AMIDES', 'AMINOPENICILLIN ANTIBIOTIC - BETA-LACTAMASE INHIBITOR COMBINATIONS': 'AMINOPENICILLINS', 'URINARY ANTISPASMODIC - ANTICHOL., M(3) MUSCARINIC SELECTIVE (BLADDER)': 'ANTISPASMODICS', 'DERMATOLOGICAL - ANTIFUNGAL-GLUCOCORTICOID COMBINATIONS': 'ANTIFUNGALS', 'PULMONARY ARTERIAL HYPERTENSION - ENDOTHELIN RECEPTOR ANTAGONISTS': 'PULMONARY HYPERTENSION - ENDOTHELIN RECEPTOR ANTAGONISTS', 'MINERALS AND ELECTROLYTES - ZINC': 'ZINC', 'INSULIN ANALOGS - LONG ACTING': 'INSULIN', 'LOCAL ANESTHETIC - SYMPATHOMIMETIC COMBINATIONS': 'SYMPATHOMIMETICS', 'ANTIRETROVIRAL-NUCLEOSIDE, NUCLEOTIDE ANALOGS AND NON-NUCLEOSIDE RTI': 'ANTIRETROVIRALS', 'OPHTHALMIC - CARBONIC ANHYDRASE INHIBITORS': 'CARBONIC ANHYDRASE INHIBITORS', 'ANTIFUNGAL - AMPHOTERIC POLYENE MACROLIDES': 'ANTIFUNGALS', 'OPHTHALMIC - LOCAL ANESTHETIC ESTERS': 'OPHTHALMIC LOCAL ANESTHETICS', 'HUMAN INSULINS - SHORT ACTING': 'INSULIN', 'ANTIHYPERGLYCEMIC - MEGLITINIDE ANALOGS': 'MEGLITINIDE ANALOGUES', 'DIRECT ACTING VASODILATORS': 'VASODILATORS', 'LAXATIVE - STIMULANT': 'STIMULANT LAXATIVES', 'SALICYLATE ANALGESICS': 'SALICYLATES', 'DIAGNOSTIC DRUGS - CARDIOVASCULAR': 'DIAGNOSTIC DRUGS'}
    ...
    for i, reference in enumerate(only_cedars):
        ...
        sorted_distances = DataFrame({'comparator': comparators, 'similarity': sorted_results}).sort_values(by=['similarity'],ascending=False).reset_index()
        partial_distances = DataFrame({'comparator': comparators, 'similarity': partial_results}).sort_values(by=['similarity'],ascending=False).reset_index()
        single_distances = DataFrame({'comparator': comparators, 'similarity': single_results}).sort_values(by=['similarity'],ascending=False).reset_index()
...
def main():
    ...
    ucla_meds = ucla_meds[~ucla_meds['PHARM_SUBCLASS'].str.contains('EACH')] #277 cases
    ...
    only_cedars = (set(cedars_meds["PHARM_SUBCLASS"].unique())).difference(set(ucla_meds["PHARM_SUBCLASS"].unique()))
